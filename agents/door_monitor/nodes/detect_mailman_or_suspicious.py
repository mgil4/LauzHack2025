...
def analyze_person(state: VLMState):
            ...
            "content": [
                {
                    ...
                    "text": (
                        ...
                        "Classify the behavior of any person approaching the door into EXACTLY one of the following categories:\n"
                        "• mailman — a known delivery person approaching the door\n"
                        "• suspicious — any unknown person or potentially threatening behavior\n\n"
                        "STRICT RULES:\n"
                        "• Output only ONE category, all lowercase.\n"
                        "• No explanations. No descriptions.\n"
                        "• If uncertain → return 'suspicious'.\n"
                        "• If multiple frames disagree, choose 'suspicious' if any frame contains suspicious behavior, otherwise 'mailman'."
                    )
                }
            ]
        },
